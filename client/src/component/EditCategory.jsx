        ...
        <section className='fixed top-0 left-0 bottom-0 right-0 bg-neutral-800/60 flex items-center justify-center'>
            <div className='bg-white  max-w-4xl w-full p-4 rounded'>
                ...
                <div className='flex items-center justify-between'>
                    <h1 className='font-semibold'>Upadte Category</h1>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex gap-4 flex-col lg:flex-row items-center'>
                            ...
                            <label htmlFor='uploadcategoryImage'>
                                <div className={`${!data.name ? "bg-gray-300" : "border-primary-200 hover:bg-primary-100"} px-4 py-1 rounded cursor-pointer border font-medium `}>
