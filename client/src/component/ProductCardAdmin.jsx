  ...
  return (
    <div className='w-36 p-4 bg-white rounded'>
      ...
      <div className='grid grid-cols-2 gap-3 py-2'>
        <button onClick={() => setEditOpen(true)} className='border px-1 py-1 border-green-600 bg-green-100 text-green-800 hover:bg-green-200 rounded text-sm'>Edit</button>
        <button onClick={() => setOpenDelete(true)} className='border px-1 py-1 border-red-600 bg-red-100 text-red-600 hover:bg-red-200 rounded text-sm'>Delete</button>
      </div>
