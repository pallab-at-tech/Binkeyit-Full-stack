        ...
        <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
            <div className=''>
                ...
                <div className='bg-white lg:min-h-[65vh] lg:max-h-[65vh] rounded min-h-56 max-h-56 h-full w-full'>
                    <img src={data?.image[image]} alt="img" className='w-full h-full object-scale-down' />
                </div>
                ...
                <div ref={imageContainer} className='grid relative'>
                    <div className='flex relative z-10 gap-4 w-full overflow-x-auto scrollbar-none'>
                        {
                            data.image.map((img, index) => {
                                return (
                                    <div key={img + index} className='w-20 h-20 min-h-20 min-w-20  cursor-pointer shadow-md'>
                ...
                <div>
                    <div className='flex items-center gap-4 my-4'>
                        ...
                        <div className='text-sm'>
                            <div className='font-semibold'>Superfast delivary</div>
                            <p>Get your order to your doorstep at the earliest from the dark store near you.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center gap-4 my-4'>
                        <img src={image3} alt="Wite Assorment" className='w-20 h-20' />
                        <div className='text-sm'>
                            <div className='font-semibold'>Wite Assorment</div>
                            <p>Choose from 5000+ across food personal care , household and others categories.</p>
                        </div>
                    </div>
